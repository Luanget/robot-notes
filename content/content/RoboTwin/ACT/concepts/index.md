...
- [[RoboTwin/ACT/01-act-overall-dataflow|ACT 整体数据流]]：总览页，适合快速回忆 ACT 从输入到输出的全流程
- [[RoboTwin/ACT/02-train-and-infer|train-and-infer]]：训练 / 推理两条数据流对照页
- [[RoboTwin/ACT/04-detr_vae|detr_vae]]：模型结构总装页
- [[RoboTwin/ACT/06-act_policy|act_policy]]：外层 loss、chunk 调用和 temporal aggregation
- [[RoboTwin/ACT/05-transformer-dataflow|ACT 中 Transformer 数据流转]]：主 transformer 内部主线
...
1. [[RoboTwin/ACT/01-act-overall-dataflow|ACT 整体数据流]]
2. [[RoboTwin/ACT/02-train-and-infer|train-and-infer]]
3. [[RoboTwin/ACT/concepts/01-latent-token|latent token]]
4. [[RoboTwin/ACT/concepts/05-query-embeddings|query embeddings]]
5. [[RoboTwin/ACT/concepts/04-memory|memory]]
6. [[RoboTwin/ACT/04-detr_vae|detr_vae]]
7. [[RoboTwin/ACT/06-act_policy|act_policy]]
8. 再补 [[RoboTwin/ACT/concepts/02-proprio-token|proprio token]]、[[RoboTwin/ACT/concepts/03-image-tokens|image tokens]]、[[RoboTwin/ACT/concepts/06-action-head|action head]]
