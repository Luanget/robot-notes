...
除了 ACT / DP / training chain 这些实现主线之外，后面也很值得单独维护一组更高层的研究方法笔记：

- [[RoboTwin/Research-Methods/index|研究能力升级]]

这一组不再重复基础模型知识，而是专门整理：
...
它更适合在已经能读代码、改模型、跑实验之后，继续往“研究判断力”方向升级。
